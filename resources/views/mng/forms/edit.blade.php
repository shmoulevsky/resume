@extends('mng.master')
@section('title', __('form-edit.Title').' «‎'.$form->name.'»')
@section('content')
        ...
        <div class="resume-inner">
            ...
            <form class="styled-form w-6/12" >
                ...
                <div id="resume-form" class="fields-wrap">
                    ...
                    <div class="mb-5">
                        <label for="">{{__('form-edit.Vacancy')}}</label>
                    ...
                    @switch($field->type)
                        ...
                        <div data-id="{{$field->id}}" class="mb-5 relative field-wrap">
                            <label class="question-title" for="">{{__('form-edit.Question')}}:</label><span class="question-required @if($field->is_required) active @endif">{{__('form-edit.Required')}}</span>
                        ...
                        @case(2)
                        <div data-id="{{$field->id}}" class="mb-5 relative field-wrap">
                            <label class="question-title" for="">{{__('form-edit.Question')}}:</label>
                            <span class="question-required @if($field->is_required) active @endif">{{__('form-edit.Required')}}</span>
                        ...
                        <div class="flex relative">
                            <label class="mb-1" for="">{{__('form-edit.Variants_answer')}}:</label>
            ...
            <button class="update-form-btn text-white bg-indigo-500 mt-8 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">{{__('form-edit.Save_btn')}}</button>
