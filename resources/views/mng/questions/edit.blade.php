@extends('mng.master')
@section('title', __('question-edit.Title'))
@section('content')
...
<div class="questions-inner">
            ...
            <form class="styled-form w-6/12" >
                ...
                <div id="question-form" class="fields-wrap relative">
                    ...
                    <div class="answers-wrap">
                        ...
                        @php $index ++; @endphp
                        <div class="mb-3">
                            <label class="answer-title answer-title-1" for="">{{ __('question-edit.Answer')}} №{{$index}}:</label>
                            <span class="right-answer state-label @if($answer->points > 0) active @endif">{{ __('question-edit.Right')}}</span>
                    ...
                    <div class="answers-wrap">
                        <div class="mb-3">
                            <label class="answer-title answer-title-3" for="">{{ __('question-edit.Answer_comparison')}} №1:</label>
                            <div class="flex">
                        ...
                        <div class="mb-3">
                            <label class="answer-title answer-title-3" for="">{{ __('question-edit.Answer_comparison')}} №2:</label>
                            <div class="flex">
                    ...
                    <div class="answers-wrap">
                        ...
                        @php $index ++; @endphp
                        <div class="mb-3">
                            <label class="answer-title answer-title-3" for="">{{ __('question-edit.Answer_chrono')}} №{{$index}}:</label>
                            <div class="flex">
            ...
            <button class="store-question-btn text-white bg-indigo-500 mt-8 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">{{ __('question-edit.Save_btn')}}</button>
            </form>
        </div>
@endsection
