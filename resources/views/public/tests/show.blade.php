...
@section('title', __('public-tests-info.Title').' '.$test->name)
@section('content')
        ...
        <div class="resume-inner bg-white overflow-hidden shadow-xl sm:rounded-lg px-10 py-10 relative">
            ...
            <div class="flex bottom-test-wrap">
                <div class="pagination-wrap">
                    <span class="title">{{__('public-tests-info.Questions')}}:</span>
                    <div class="flex">
                ...
                <div>
                    <button class="finish-test bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded">{{__('public-tests-info.Finish')}}</button>
                </div>
