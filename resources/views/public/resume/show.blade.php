...
@section('title', __('public-resume-show.Title', ['vacancy' => $form->name, 'company' => $company->name]))
@section('content')
<div class="py-12 bg-gray-50 h-screen">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="resume-inner bg-white overflow-hidden shadow-xl sm:rounded-lg px-10 py-10">
            ...
            <h1 class="text-4xl mb-5"><span class="text-gray-400">{{__('public-resume-show.Resume')}}</span> &laquo;{{$form->name}}&raquo;</h1>
            <h2 class="text-2xl mb-10"><span class="text-gray-400">{{__('public-resume-show.Company')}}:</span> {{$company->name}}</h2>


            <div class="block mt-12">
                <h2>{{__('public-resume-show.Test list')}}:</h2>
